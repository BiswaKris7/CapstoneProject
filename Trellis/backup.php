...
<body>
    ...
    <section class="booking">
        ...
        <table>
            <tr>
                <th>Departure Station</th><th>Destination Station</th><th>Travel Date</th><th>Status</th>
            </tr>
            <?php
            $user_id = $_SESSION["user_id"];
            $result = $conn->query("SELECT departure_station, destination_station, travel_date, status FROM bookings WHERE user_id = $user_id");
